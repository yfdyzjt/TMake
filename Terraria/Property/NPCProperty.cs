...
public static class NPCProperty
    {
        public static readonly Dictionary<string, int> NpcIds = new Dictionary<string, int> {
        { "NegativeIDCount", -66 },
{ "BigHornetStingy", -65 },
{ "LittleHornetStingy", -64 },
{ "BigHornetSpikey", -63 },
...
{ "Count", 688 }
        ...
        public static readonly Dictionary<int, string> NpcNames = NpcIds.ToDictionary(k => k.Value, p => p.Key);
    }
